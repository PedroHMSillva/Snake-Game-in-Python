...
class Game:
    ...
    def __init__(self):
        ...
        f = square(random.randint(grid_size,( width/grid_size))*grid_size - grid_size, random.randint(grid_size, (heigh/grid_size))*grid_size - grid_size, 'blue')
        ...
        while(True):
            ...
            for i in range(2, len(self.snake)  ):
                if(counter < 1):
                    ...
                    showinfo(title="Fim de Jogo",message= "FIM DE JOGO!!!")
                    exit()


            self.canvas.after(90)
